...
function Nav (){
        ...
        return (
               ...
               <nav className={`nav ${menuOpen ? "open" : ""}`}>
                ...
                <NavLink to="/" className={`nav-item ${menuOpen ? "open" : ""}`} onClick={toggleMenu}>Home</NavLink>
                <NavLink to="/about" className={`nav-item ${menuOpen ? "open" : ""}`} onClick={toggleMenu}>About</NavLink>
